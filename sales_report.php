...
<div class="container mx-auto max-w-3xl bg-white p-6 rounded-lg shadow-md">
    <h2 class="text-2xl font-semibold text-center mb-4 text-gray-800">Sales Report</h2>
        ...
        <table class="w-full mt-4 border-collapse border border-gray-300 shadow-sm">
            <thead class="bg-gray-200">
                <tr>
                    ...
                    <th class="px-4 py-2 border border-gray-300">Units Sold</th>
            ...
            <tbody>
                ...
                <tr class="bg-white hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 border border-gray-300"><?php echo $row["sellunit"]; ?></td>
                    <td class="px-4 py-2 border border-gray-300"><?php echo $row["totalprice"]; ?></td>
                </tr>
                <?php
                        }
                    } else {
